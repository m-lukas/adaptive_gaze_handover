...
def draw_eyes():
    ...
    if not is_blinking:
        ...
        if not moving_down and not moving_up and not moving_left and not moving_right:
            left_mini_pupil_pos = (
                left_pupil_pos[0] + m_pupil_offset[1],
                left_pupil_pos[1],
            )
            right_mini_pupil_pos = (
                right_pupil_pos[0] + m_pupil_offset[1],
                right_pupil_pos[1],
            )
    ...
    RECT1 = pygame.Rect(
        (eye_left_pos[0] - 50 + lid_offset[0], 100 + lid_offset[1]),
        (eye_radius_ * 1.3, 200),
    )
    RECT2 = pygame.Rect(
        (eye_right_pos[0] - 50 + lid_offset[0], 100 + lid_offset[1]),
        (eye_radius_ * 1.3, 200),
    )
    ...
    pygame.draw.arc(
        screen, LID, RECT1, start_angle=2 / 6 * PI, stop_angle=5.5 / 6 * PI, width=25
    )
    pygame.draw.arc(
        screen,
        LID,
